...
class OperationsPreviewParameterProvider : PreviewParameterProvider<OperationsViewModel.State> {
    override val values: Sequence<OperationsViewModel.State> = sequenceOf(
        // Loading
        ...
        OperationsViewModel.State(
            ...
            groupedOperations = mapOf(
                "Aujourd'hui" to listOf(
                    Operation(
                        id = "1", title = "Payment CB", amount = -50.0, category = "Food", date = 1678886400
                    ),
                    Operation(
                        id = "2", title = "Transfer Received", amount = 1000.0, category = "Salary", date = 1678886400
                    )
                ),
                "Hier" to listOf(
                    Operation(
                        id = "3", title = "Netflix", amount = -15.0, category = "Subscription", date = 1678800000
                    )
                )
            )
        )
